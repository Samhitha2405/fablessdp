...
<body>
    ...
    <div class="monument-card">
        <img src="images/fables_tajmahal.jpg" alt="Taj Mahal">
        <h3>Taj Mahal</h3>
    ...
    <div class="monument-card">
        <img src="images/fables_qutubminar.jpg" alt="Qutub Minar">
        <h3>Qutub Minar</h3>
    ...
    <div class="monument-card">
        <img src="images/fables_redfort.jpg" alt="Red Fort">
        <h3>Red Fort</h3>
    ...
    <div class="monument-card">
        <img src="images/fables_goldentemple.jpg" alt="Golden Temple">
        <h3>Golden Temple</h3>
    ...
    <div class="monument-card">
        <img src="images/fables_gatewayofindia.jpg" alt="Gateway of India">
    ...
    <div class="monument-card">
        <img src="images/fables_indiagate.jpg" alt="India Gate">
        <h3>India Gate</h3>
