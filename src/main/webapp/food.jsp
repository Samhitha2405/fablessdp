...
<body>
    ...
    <div class="monument-card">
        <img src="images/foodap.jpg" alt="Andhra Pradesh">
    ...
    <div class="monument-card">
        <img src="images/foodtelangana.jpg" alt="Telangana">
        <h3>Telangana</h3>
    ...
    <div class="monument-card">
        <img src="images/foodtamil.jpg" alt="Tamil Nadu">
        <h3>Tamil Nadu</h3>
    ...
    <div class="monument-card">
        <img src="images/foodkarnataka.jpg" alt="Karnataka">
        <h3>Karnataka</h3>
    ...
    <div class="monument-card">
        <img src="images/foodkerala.jpg" alt="Kerala">
        <h3>Kerala</h3>
    ...
    <div class="monument-card">
        <img src="images/foododisa.jpg" alt="Odisa">
        <h3>Odisa</h3>
