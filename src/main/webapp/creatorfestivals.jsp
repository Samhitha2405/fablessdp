...
<body>
    ...
    <div class="monument-card">
        <img src="images/dussehra.jpg" alt="dussehra">
        <h3>Dusshera</h3>
    ...
    <div class="monument-card">
        <img src="images/diwalifab.jpg" alt="diwali">
        <h3>Diwali</h3>
    ...
    <div class="monument-card">
        <img src="images/ganesh.jpg" alt="ganesh">
    ...
    <div class="monument-card">
        <img src="images/krishna.jpg" alt="KrishnaJanmastami">
    ...
    <div class="monument-card">
        <img src="images/sankranthi.jpg" alt="sankranthi">
    ...
    <div class="monument-card">
        <img src="images/ramnavami.jpg" alt="ramnavami">
        <h3>Ram Navami</h3>
